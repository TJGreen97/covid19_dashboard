...
def update_country(_, clickData, country, pie_fig, stats_fig, rates_fig):
    ...
    Arguments:
        ...
        rates_fig {dict} -- figure dict of current line chart
    ...
    return (
        selected_country,
        update_pie(selected_country, data, pie_fig),
        selected_country,
        selected_country,
        update_country_stats(selected_country, data, stats_fig),
        update_line(selected_country, rates_fig),
    )
